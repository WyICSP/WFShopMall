...
#define CollectionPageListPath [[NSBundle bundleForClass:[self class]] pathForResource:@"CollectionPageList" ofType:@"plist" inDirectory:@"WFStatistics.bundle"]

#define CollectionEventListPath [[NSBundle bundleForClass:[self class]] pathForResource:@"CollectionEventList" ofType:@"plist" inDirectory:@"WFStatistics.bundle"]
